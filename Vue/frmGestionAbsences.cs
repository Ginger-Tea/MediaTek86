...
namespace MediaTek86.Vue
{
    ...
    public partial class frmGestionAbsences : Form
    {
        ...
        /// <summary>
        /// Supprime une absence sélectionnée
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnSupprimerAbs_Click(object sender, EventArgs e)
        {
            if (dgvAbsences.SelectedRows.Count > 0)
            {
                ...
                /// <summary>
                /// Confirmation de suppression de l'absence
                /// </summary>
        ...
        private void btnModifierAbs_Click(object sender, EventArgs e)
        {
            if (dgvAbsences.SelectedRows.Count > 0)
            {
                ...
                // On stock les données dans la variable "absInitiale"
                ...
                // Stockage de la saisie des modifications dans la variable "absUpdate"
