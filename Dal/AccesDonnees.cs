...
namespace MediaTek86.Dal
{
    ...
    {
        /// <summary>
        /// Chaine de connexion à la BDD (localhost)
        /// </summary>
        private static string connectionString = "server=localhost;database=mediatek;uid=root;";
        ...
        public static List<Personnel> GetLesPersonnels()
        {
            ...
            //Requete SQL de selection de la liste des personnels sur chaque colonne, des noms et des services de la table service
